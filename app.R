...
### Ouverture des bases
fuaPa_DC <- read_xlsx("Output/Paris/Dispositifs_Paris.xlsx", sheet = "Brut")
...
QPV_Pa <- st_read("Output/Paris/Paris_TVA.gpkg", layer = "QPV_Fu")
PNRU_Pa <- st_read("Output/Paris/Paris_TVA.gpkg", layer = "PNRU_Fu")
...
### Ouverture des bases
fuaLy_DC <- read_xlsx("Output/Lyon/Dispositifs_Lyon.xlsx", sheet = "Brut")
...
### Les secteurs TVA réduite
QPV_Ly <- st_read("Output/Lyon/Lyon_TVA.gpkg", layer = "QPV_Fu")
PNRU_Ly <- st_read("Output/Lyon/Lyon_TVA.gpkg", layer = "PNRU_Fu")
...
### Les secteurs TVA réduite
QPV_Av <- st_read("Output/Avignon/Avignon_TVA.gpkg", layer = "QPV_Fu")
PNRU_Av <- st_read("Output/Avignon/Avignon_TVA.gpkg", layer = "PNRU_Fu")
